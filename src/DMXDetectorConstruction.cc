...
//  physAr = new G4PVPlacement(0, G4ThreeVector(0.,0.,0.5*(P_w+V_l+P_p)+0.5*(P_w-P_p)+1*m+0.5*A_l), logicAr, "physAr", logicWorld, false, 0);
  ...
  physVac2 = new G4PVPlacement(0, G4ThreeVector(0.,0.,0.5*(V_l+2*P_p)+0.5*SD_T), logicVac2, "physVac2", logicWorld, false, 0);
  ...
  physVac3 = new G4PVPlacement(0, G4ThreeVector(0.,0.,0.5*(V_l+2*P_p)+SD_D+0.5*SD_T), logicVac3, "physVac3", logicWorld, false, 0);
